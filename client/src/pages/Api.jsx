          ...
          <div className="p-6">
            {selectedTab === 'overview' && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                <div>
                  <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Getting Started</h3>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                    <h4 className="font-semibold text-gray-800 dark:text-white mb-2">Base URL</h4>
                    <code className="text-red-600 dark:text-red-400 bg-white dark:bg-gray-900 px-2 py-1 rounded border dark:border-gray-700">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Rate Limits</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                      <h5 className="font-medium text-blue-800 dark:text-blue-300">Free Tier</h5>
                      <p className="text-blue-600 dark:text-blue-400 text-sm">1,000 requests/month</p>
                    </div>
                    <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-4">
                      <h5 className="font-medium text-red-800 dark:text-red-300">Pro Tier</h5>
                      <p className="text-red-600 dark:text-red-400 text-sm">100,000 requests/month</p>
                    </div>
                  </div>
                </div>
              </motion.div>
            ...
            {selectedTab === 'endpoints' && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
                {endpoints.map((endpoint) => (
                  <div key={endpoint.path} className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                    <div className="bg-gray-50 dark:bg-gray-800 px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <code className="text-gray-800 dark:text-gray-300 font-mono">{endpoint.path}</code>
                        </div>
                        <button
            ...
            {selectedTab === 'authentication' && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                <div>
                  <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">API Authentication</h3>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-yellow-800 dark:text-yellow-300">API Key Required</h4>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Example Request</h4>
                  <div className="bg-gray-900 dark:bg-gray-800 rounded-lg p-4 overflow-x-auto">
                    <pre className="text-sm text-gray-300 dark:text-gray-400">
